...
<div id="HeaderMenuInfo">
  <div style="display:inline-block; margin:0px 8px;">
    ...
    <el-button type="danger">存款點數 {{today.deposit}}</el-button>
    <el-button type="success">提款點數 {{today.withdrawal}}</el-button>
    </span>
    <span style="display:inline-block; margin:0px 4px;">{{count}}</span>
    <span style="display:inline-block; margin:0px 4px;"><font-awesome-icon icon="sync-alt" :spin="isLoading" @click="getTodayList" /></span>
  </div>
